...
// configuration step. It creates a namespace called `oxeng64`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", oxeng64::cmake::project_name, oxeng64::cmake::project_version) };
